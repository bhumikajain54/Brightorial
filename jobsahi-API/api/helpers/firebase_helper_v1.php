...
class FirebaseHelperV1 {
    ...
    private static $SERVICE_ACCOUNT_PATH = __DIR__ . '/../../config/firebase-service-account.json';
    ...
    private static function getAccessToken() {
        ...
        if (!file_exists(self::$SERVICE_ACCOUNT_PATH)) {
            error_log("Firebase Service Account JSON file not found at: " . self::$SERVICE_ACCOUNT_PATH);
            return false;
        }
